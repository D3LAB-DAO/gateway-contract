...
use state::{Config, CONFIG, ExecResult, PROJECT, Project, REQUEST, RequestID, ResultRequest};
...
pub fn result_request(deps: DepsMut, _env: Env, _info: MessageInfo, user: Addr, id: i32, input: String) -> StdResult<Response> {
    ...
    let result = ResultRequest { req_id: req_id + 1, user, input };
...
pub fn save_exec_result(deps: DepsMut, _env: Env, _info: MessageInfo, user: Addr, project_id: i32, req_id: i32, request: String, result: String) -> StdResult<Response> {
